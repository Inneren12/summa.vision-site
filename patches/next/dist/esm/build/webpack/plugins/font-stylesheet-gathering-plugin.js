  ...
  apply(compiler) {
    ...
    compiler.hooks.make.tapAsync(this.constructor.name, (compilation, cb) => {
      compilation.hooks.finishModules.tapAsync(
        ...
        async (modules, modulesFinished) => {
              ...
              module == null
                ...
                : (_module_buildInfo = module.buildInfo) == null
                  ...
                  : (_module_buildInfo_valueDependencies = _module_buildInfo.valueDependencies) ==
                      null
                    ? void 0
                    : _module_buildInfo_valueDependencies.get(AUTOMATIC_FONT_OPTIMIZATION_MANIFEST);
            if (fontDependencies) {
          ...
          compilation.assets[AUTOMATIC_FONT_OPTIMIZATION_MANIFEST] = new sources.RawSource(
    ...
    compiler.hooks.make.tap(this.constructor.name, (compilation) => {
      compilation.hooks.processAssets.tap(
        ...
        (assets) => {
          assets["../" + AUTOMATIC_FONT_OPTIMIZATION_MANIFEST] = new sources.RawSource(
            JSON.stringify(this.manifestContent, null, "  "),
          );
        },
      );
