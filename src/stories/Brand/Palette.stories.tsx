...
const paletteGroups: PaletteGroup[] = [
  {
    ...
    swatches: [
      ...
      { token: 'color.accent.yellow', label: 'Yellow', previewText: 'Yellow', textColorToken: 'color.fg.default' },
    ],
  },
  {
    title: 'Neutral Ramp',
    ...
    swatches: [
      { token: 'color.neutral.000', label: '000', previewText: '000', textColorToken: 'color.fg.muted' },
      { token: 'color.neutral.050', label: '050', previewText: '050', textColorToken: 'color.fg.muted' },
      { token: 'color.neutral.100', label: '100', previewText: '100', textColorToken: 'color.fg.muted' },
      { token: 'color.neutral.200', label: '200', previewText: '200', textColorToken: 'color.fg.muted' },
      { token: 'color.neutral.300', label: '300', previewText: '300', textColorToken: 'color.fg.muted' },
  ...
  },
  {
    ...
    swatches: [
      { token: 'color.bg.canvas', label: 'Canvas', previewText: 'Canvas', textColorToken: 'color.fg.muted' },
      { token: 'color.bg.surface', label: 'Surface', previewText: 'Surface', textColorToken: 'color.fg.muted' },
      { token: 'color.bg.elevated', label: 'Elevated', previewText: 'Elevated', textColorToken: 'color.fg.muted' },
      { token: 'color.bg.subtle', label: 'Subtle', previewText: 'Subtle', textColorToken: 'color.fg.muted' },
      { token: 'color.bg.inverse', label: 'Inverse', previewText: 'Inverse' },
      { token: 'color.fg.default', label: 'FG Default', previewText: 'Aa', textColorToken: 'color.bg.canvas' },
      { token: 'color.fg.muted', label: 'FG Muted', previewText: 'Aa', textColorToken: 'color.bg.canvas' },
      { token: 'color.fg.subtle', label: 'FG Subtle', previewText: 'Aa', textColorToken: 'color.bg.canvas' },
  ...
  },
  {
    ...
    swatches: [
      ...
      { token: 'color.status.warn', label: 'Status Warn', previewText: 'Warn', textColorToken: 'color.bg.canvas' },
    ...
    <article className="brand-card">
      ...
      <div className="brand-card__body">
        <div>
          ...
          <p className="brand-note">Foreground, background, and border tokens for status messaging.</p>
        </div>
        <div className="brand-token-meta">
          <div>
